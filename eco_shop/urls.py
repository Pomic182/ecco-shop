...
from products.views import create_food, create_freshfood, create_drinks, list_drinks, list_food, list_freshfood, search_food
...
urlpatterns = [
    ...
    path('search_food/', search_food, name='search_products') 
]
